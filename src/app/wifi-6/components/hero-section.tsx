...
export function HeroSection() {
  return (
    <section className="relative flex h-[100dvh] w-full flex-col items-center justify-center overflow-hidden pt-28 md:pt-16">
      {/* Background Elements */}
      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8 text-center flex flex-col items-center gap-5 pt-6">
        {/* Badge */}
        ...
        {/* Headline */}
        <h1 className="max-w-4xl text-4xl font-black leading-tight tracking-tight text-white sm:text-6xl glow-text">
        ...
        <div className=" flex flex-col items-center justify-center">
          ...
          <span className="mt-4 text-sm font-medium text-emerald-400 max-w-md">
