        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            <li className="flex items-center justify-center lg:justify-start gap-2">
              <Phone className="w-4 h-4" /> {content.contactInfo.phone}
            </li>
            <li className="flex items-center justify-center lg:justify-start gap-2">
              <Mail className="w-4 h-4" /> {content.contactInfo.email}
            </li>
            <li className="flex items-center justify-center lg:justify-start gap-2">
              <MapPin className="w-4 h-4" /> {content.contactInfo.address}
            </li>
          </ul>
        </div>
      </div>
