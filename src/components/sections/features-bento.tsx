      ...
      <div className="relative container mx-auto px-4 md:px-10 max-w-7xl">
        <div className="flex flex-col md:flex-row gap-12 items-start">
          ...
          <div className="flex-1 md:sticky md:top-24">
            <h2 className="text-[var(--color-primary)] text-sm font-bold uppercase tracking-widest mb-2">
              Diferenciales
            </h2>
            <h3 className="text-3xl md:text-4xl font-black text-[#0e151b] dark:text-white mb-6 leading-tight">
            ...
            <button className="group flex items-center gap-2 text-[var(--color-primary)] font-bold hover:text-[var(--color-secondary)] transition-colors">
          ...
          <div className="flex-[1.5] grid grid-cols-1 sm:grid-cols-2 gap-4 w-full">
            {/* Card 1 */}
            <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-6 rounded-2xl flex flex-col gap-4 shadow-sm hover:shadow-md transition-all group">
